          ...
          <section id="coaching">
            ...
            <div className="flex flex-col 2xl:flex-row">
              <div className="bg-site-bg-dim self-center w-[70%] rounded-b-2xl 2xl:rounded-br-none 2xl:rounded-l-2xl 2xl:order-1 order-2">
                <p className="p-6">From private tutoring in school, to writing scripts for my high-level breakdowns, I've always had a knack for breaking down complex topics into simpler, digestible lessons you can apply immediately. Not to mention having studied computer science at university - having directly studied the art of puzzle solving - there is no weakness within you that I cannot bring into the spotlight.<br/><br/> I coach on Metafy and offer different coaching packages from single sessions to month long personal training. With plenty reviews to boot, the only reason to not get some coaching right now is I'm currently on a hiatus. Real life takes priority, and I've recently started a new full-time job, so I've decided to take a break until I get settled in.</p>
              </div>
